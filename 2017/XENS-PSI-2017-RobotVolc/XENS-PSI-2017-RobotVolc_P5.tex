\section{Étude de l'action de préhension}
...
% Q5.2
\question{Déterminer la liaison équivalente entre le mors 5 et l'objet à saisir. Cette liaison équivalente
...
$Kt$ &  constante de couple 	& \SI{0,82}{Nm/A} \\ \hline
$Ke$ &  constante de fcem 	& \SI{86}{V/1000tr/min} \\ \hline
$J_{eq}$ &  moment d'inertie 	& \SI{3,45e-4}{ kg m^2} \\ \hline
$Kr$ &  rapport du réducteur 	& $54/33=1,636$ \\ \hline
$K_{ve}$ & pas du système vis-écrou & $\SI{4}{mm}$  \\ \hline
\end{tabular}
\end{table}
