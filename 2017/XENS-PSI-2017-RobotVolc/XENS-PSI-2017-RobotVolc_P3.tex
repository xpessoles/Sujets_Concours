...
Le cahier des charges impose de monter des pentes de 50\deges, on obtient donc une hauteur limite $h$ après application numérique : $\indice{h}{lim}=0.6/1.2=\SI{0,5}{m}$.
...
\end{itemize}
Théorème du Moment sur y ⃗ au point B :
 -mgh sin⁡〖α+〗  mg(a-b)cos⁡〖α-〗 N_AV (a-b)-T_AV h=0
A la limite du basculement, les efforts sur la roue avant sont nuls et l’équation de moment devient :
-mgh_lim  sin⁡〖α+〗  mg(a-b)cos⁡〖α=0〗 soit encore 
