...
\question{étant donnée $A$ la liste définie à la question~2, que renvoie \lstinline{avancer(avancer(A, False),True)} ?}
\ifprof
\begin{corrige}
...
L'objectif de cette partie est de définir en \lstinline{lstlisting} l'algorithme permettant d'effectuer une étape
