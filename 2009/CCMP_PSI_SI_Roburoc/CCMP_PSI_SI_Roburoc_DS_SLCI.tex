...
% & Pente du relief à vide &\ang{45} & Valeur maximale  \\ \cline{2-4}
% & Débattement angulaire en tangage du bras 4 par rapport au pode central 1 & de $\ang{-45}$ à $\ang{+30}$ & -----  \\ \cline{2-4}
% & Débattement angulaire en tangage du bras 4' par rapport au pode central 1 & de $\ang{+45}$ à $\ang{-30}$ & ----- \\ \cline{2-4}
% & Débattement angulaire en roulis du pode avant 3 par rapport au bras 4 & de $\ang{-45}$ à $\ang{+45}$ & ----- \\ \cline{2-4}
% & Débattement angulaire en roulis du pode arrière 2 par rapport au bras 4' & de $\ang{+45}$ à $\ang{-45}$ & ----- \\
% \hline
...
% & Débattement angulaire en tangage du bras 4' par rapport au pode central 1 & de $\ang{+45}$ à $\ang{-30}$ & ----- \\ %\cline{2-4}
% & Débattement angulaire en roulis du pode avant 3 par rapport au bras 4 & de $\ang{-45}$ à $\ang{+45}$ & ----- \\ %\cline{2-4}
% & Débattement angulaire en roulis du pode arrière 2 par rapport au bras 4' & de $\ang{+45}$ à $\ang{-45}$ & ----- \\ \hline
...
%\question{\label{q_01} Compléter le diagramme des exigences de la plate-forme d'exploration présenté dans le document réponse en indiquant les solutions techniques associées aux fonctions techniques référencées.}% Pour cela, vous associerez aux fonctiosn techniques FT1, FT2, FT311, FT312, FT321, FT33, FT41, FT51, FT61, FT71.}
%\ifprof
%\begin{corrige}
%\end{corrige}
%\else
...
%$\beta$
%varie entre $-\ang{45}$ et $\ang{+30}$. Les valeurs négatives correspondent à un mouvement de PLONGEE du pode avant, les
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=.8\linewidth]{cor_q4}
%\end{figure}
%\end{corrige}
%\else
%\fi
...
%Valeurs numériques : 
%\begin{itemize}
% \item $d_4 =\SI{70}{mm}$; $h_1 =\SI{292}{mm}$; $d_1 =\SI{76}{mm}$; $\beta \in \left[ \ang{-45};\ang{+30}\right]$.
%\end{itemize}
%\fi
%
...
%\end{figure}
%On observe que le maximum de la course est pour $\beta=\ang{-45}$ et le minimum $\beta=30\degres$.
%
...
% D'aprés l'annexe, lorsque $\beta = \ang{-45}$, $\dfrac{F_{v5}+F_{v6}}{m_E g}=8,4$.
% 
...
%%(question \ref{q_15}). Vous veillerez en particulier à :} \vspace{-.5cm}
%%\textit{
%%\begin{itemize}
...
& Rapidité : temps de réponse à 5\% (à une entrée en échelon de vitesse) & \SI{0,5}{s} \\
 \hline
\end{tabular}
\end{center}
\fi
...
\begin{figure}[H]
\centering
\includegraphics[width=.95\linewidth]{img_10}
\caption{Schéma-blocs à retour unitaire\label{img:10}}
\end{figure}
...
\item Possibilité 2 : d'après le diagramme de Bode de la boucle ouverte, le gain est toujours négatif et la phase toujours supérieure à $\ang{-180}$. D'après le critère du Revers, le système est stable.  
\end{itemize}
\end{corrige}
\else
...
Il annule l'écart statique. Il ajoute \ang{90} de déphasage ce qui peut déstabiliser le système.
\end{corrige}
\else
\fi
...
\question{\label{q_21}Compléter le document-réponse %(Bode non corrigé page 12) 
en traçant les diagrammes de Bode du correcteur avec $K_I =\SI{1}{s^{-1}}$ . Déterminer alors la valeur de $K_I$ maximale notée $K_{\text{I max}}$ permettant de respecter les marges de stabilité énoncées dans le cahier des charges.}
\ifprof
\begin{corrige}
En ajoutant un correcteur intégral pur, de gain $\SI{1}{s^{-1}}$ la marge de phase serait de \ang{65}. La marge de gain serait de $\SI{50}{dB}$. 

Pour avoir une marge de gain de\ang{45}, il faut remonter, au maximum le gain de \SI{10}{dB}. Soit $\indice{K}{I max} = 10^{10/20}=\SI{3,16}{s^{-1}}$. La marge de gain serait alors de \SI{40}{dB} ce qui est supérieur au \SI{6}{dB} du cahier des charges. 
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\linewidth]{cor_q23.png}
%\caption{Loi de commande de vitesse \label{img:04}}
\end{figure}
\end{corrige}
\else
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\linewidth]{cor_q24.png}
%\caption{Loi de commande de vitesse \label{img:04}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\linewidth]{cor_q25.png}
%\caption{Loi de commande de vitesse \label{img:04}}
\end{figure}
\end{corrige}
\else
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=\linewidth]{cor_q26.png}
%%\caption{Loi de commande de vitesse \label{img:04}}
%\end{figure}
%\end{corrige}
%\else
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=.9\linewidth]{cor_q27.png}
%\includegraphics[width=.9\linewidth]{cor_q27_b.png}
%%\caption{Loi de commande de vitesse \label{img:04}}
%\end{figure}
%\end{corrige}
%\else
...
%\ifprof
%\else
%%\includepdf[pages=2-]{Annexes.pdf}
%\includepdf{Annexes.pdf}
%\fi
