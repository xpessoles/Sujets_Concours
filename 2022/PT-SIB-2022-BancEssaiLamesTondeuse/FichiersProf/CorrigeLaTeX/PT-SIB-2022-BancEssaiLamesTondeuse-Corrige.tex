...
\paragraph*{Solution 1 -- Probablement fausse}
La contrainte de cisaillement peut s'exprimer par $\sigma_c = \frac{F_c}{eb}$.
D'une part, il y a rupture de l'ergot lorsque $\sigma_c \geq R_m$. Au moment de la rupture, on fait donc l'hypothèse que $R_m = \frac{F_c}{eb}$.
...
La section cisaillée est perpendiculaire au plan du dessin et $C_{cis} = \dfrac{eb}{\cos 30}$
