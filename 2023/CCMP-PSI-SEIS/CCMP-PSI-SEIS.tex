...
%Q12. 
\question{\label{ccmp2023_q_12}Quel plan de symétrie de l'ensemble mobile $\{(2)+(3)\}$ serait cohérent avec les valeurs numériques de la matrice d'inertie $\overline{\bar{I}}_{\left(O_{1}, 2+3\right)}$ déterminée par le logiciel de CAO ? En déduire, sous sa forme littérale, l'écriture simplifiée de la matrice d'inertie.}
...
%Q25. 
\question{\label{ccmp2023_q_25}En s'appuyant sur les données numériques de la TABLE 4 et de l'Annexe 5, justifier que, pour la valeur retenue de $K_{1}$, la fonction de transfert peut s'écrire sous la forme :
$$
...
%Q29. 
\question{\label{ccmp2023_q_29}Choisir, en justifiant, la valeur de $K_{4}$ qui permet de vérifier au mieux les exigences 3.3 et 3.4. Les tracés nécessaires apparaitront sur la FiguRe $\mathrm{C}$ du Cahier Réponses.}
...
\begin{figure}[!h]
\centering
\includegraphics[width=.5\textwidth]{2024_04_26_3285cfc264024262add0g-15(3)}
...
\begin{figure}[!h]
\centering
\includegraphics[width=.5\textwidth]{2024_04_26_3285cfc264024262add0g-15(2)}
