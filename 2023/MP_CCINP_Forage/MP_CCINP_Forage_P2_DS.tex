...
\ifprof
 \begin{corrige}
 \textbf{UPSTI} --  
 $\indice{K}{ihm}$ permet de s'assurer qu'en régime permanent, l'image de l'erreur $\epsilon_{V}$ est nulle lorsque l'erreur est nulle, qu'elle que soit la consigne.
