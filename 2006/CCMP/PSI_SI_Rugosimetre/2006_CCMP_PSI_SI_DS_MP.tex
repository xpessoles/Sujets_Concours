...
\ifprof
\begin{corrige}
De plus $\vectmc{A}{3}{0} = \inertie{A}{3} \vecto{3}{0}  + m_3 \vect{AG_3}\wedge \vectv{A}{3}{0}$ 
$= \matinertie{A}{B}{C}{-D}{-E}{-F}{A,\mathcal{B}_3} \begin{pmatrix} 0  \\ \dot{\theta} \\ 0 \end{pmatrix}_{\rep{3}}
+ m_3 r\vect{x_3}\wedge \dot{x}\vect{x_0} $ 

$ =\begin{pmatrix} -F\dot{\theta}  \\ B\dot{\theta} \\ -D\dot{\theta} \end{pmatrix}_{\rep{3}} -  m_3 r\sin\theta \dot{x}\vect{y_0} $. 
...
\item$\deriv{\vectmc{A}{3}{0}\cdot \vect{y_3}}{} = B\ddot{\theta} - m_3 r\dot{x}\dot{\theta}\cos\theta - m_3 r\sin\theta \ddot{x}$.
...
$$\vectmd{A}{3}{0}\cdot\vect{y_0} = B\ddot{\theta} - m_3 r\dot{x}\dot{\theta}\cos\theta - m_3 r\sin\theta \ddot{x} + r  \dot{\theta} m_3 \dot{x} \cos \theta $$
\end{corrige}
\else
\fi
...
\item $\vectmd{A}{3}{0}\cdot\vect{y_0} = B\ddot{\theta} - m_3 r\dot{x}\dot{\theta}\cos\theta - m_3 r\sin\theta \ddot{x} + r  \dot{\theta} m_3 \dot{x} \cos \theta $ 
...
\fi
\subparagraph{\label{q_13a}}\textit{Tracer le diagramme de la fonction de transfert en boucle ouverte $H_{\text{BO}}(p)=\dfrac{K_p}{p}K_{\text{mot}}\dfrac{K_t}{1+\dfrac{2\xi}{\omega_0}p+\dfrac{p^2}{\omega_0^2}}$.}
