...
\item $\ec{3}{0} = \dfrac{1}{2} \torseurl{\dot{\theta} \vect{y_0}}{ \dot{x}\vect{x_0} -r  \dot{\theta}\vect{z_3}}{G_3} \otimes \torseurl{m_3\left(\dot{x}\vect{x_0} -r  \dot{\theta}\vect{z_3}\right)}{-F\dot{\theta} \vect{x_3} + B\dot{\theta} \vect{y_3}  -D\dot{\theta}  \vect{z_3}}{G_3}$ 
$ = \dfrac{1}{2} m_3\left(\dot{x}\vect{x_0} -r  \dot{\theta}\vect{z_3}\right)^2 + \dfrac{1}{2}B\dot{\theta}^2$

$ = \dfrac{1}{2} m_3\left(\dot{x}^2 +r^2  \dot{\theta}^2 - 2r\dot{\theta}\dot{x}  \sin \theta \right)+ \dfrac{1}{2}B\dot{\theta}^2$
et

 $\deriv{\ec{3}{0}}{} =m_3\left(\dot{x}\ddot{x} +r^2  \dot{\theta}\ddot{\theta} - r\ddot{\theta}\dot{x}  \sin \theta- r\dot{\theta}\ddot{x}  \sin \theta- r\dot{\theta}^2\dot{x}  \cos \theta \right)+ B\dot{\theta}\ddot{\theta} $
\end{itemize}
...
$$
m_3\left(\dot{x}\ddot{x} +r^2  \dot{\theta}\ddot{\theta} - r\ddot{\theta}\dot{x}  \sin \theta- r\dot{\theta}\ddot{x}  \sin \theta- r\dot{\theta}^2\dot{x}  \cos \theta \right)+ B\dot{\theta}\ddot{\theta}
+ m_2 \dot{x}\ddot{x}
