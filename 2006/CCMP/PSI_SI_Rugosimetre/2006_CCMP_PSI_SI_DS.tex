...
Le coût estimé de ce rugomimètre est de 10 000 euros.
...
% Q01
%\subparagraph{\label{q_01}}\textit{Compléter le tableau du document réponse, en donnant les différents critères de performance et les niveaux associés du rugosimètre.}
...
\section{Calculs prévisionnels des actionneurs}
...
\begin{figure}[H]
\centering
\includegraphics[height=6cm]{fig_13}
\end{figure}
\end{minipage}\hfill
\begin{minipage}[c]{.5\linewidth}
\begin{figure}[H]
\centering
\includegraphics[height=6cm]{fig_14}
%\caption{\label{fig_14} Pseudo période en fonction de la pulsation
%propre et du coefficient d’amortissement}
\end{figure}
\end{minipage}
...
\textbf{Question \ref{q_13a}}
\begin{figure}[H]
\centering
\includegraphics[width=.8\linewidth]{bode}
%\caption{\label{fig_12} Réponse indicielle adimensionnée (sortie/valeur finale de la sortie)}
\end{figure}
%\subsection{}
%\section{}
%
%\subparagraph{\label{q_}}\textit{ }
%
%
%\begin{figure}[H]
%\centering
%%\includegraphics[width=.8\linewidth]{fig_}
%\caption{\label{fig_} }
%\end{figure}
\textbf{Question \ref{q_14}}

\begin{figure}[H]
\centering
\includegraphics[width=.8\linewidth]{fig_16_bis}
%\caption{\label{fig_16b} Zoom de la réponse indicielle adimensionnée de l’Unité de Rotation}
\end{figure}
