...
\begin{center}
\includegraphics[width=.75\linewidth]{cor_04}
\end{center}
%\caption{Stabilité << de formes >> \label{fig_02_quille}}
...
\end{center}
$| C(j\omega^*)|_{dB} = 20 \log \indice{K}{Cor} - 10 \log (1+b) + 10\log \left(1+\dfrac{1}{b}\right) = -10\log b$.
...
\begin{corrige}~\\
\begin{center}
\includegraphics[width=.6\linewidth]{cor_06}
\end{center}
